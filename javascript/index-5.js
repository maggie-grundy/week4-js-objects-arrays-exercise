...
function createPet(name, species, energy, happiness) {
  return {
    ...
    energy: energy,
    happiness: happiness,
    //Modify play method to increase happiness by 10 and decrease energy by 15
    play: function () {
      this.energy -= 10;
      this.happiness += 15;
...
//For loops to play with pets, feed only those with low energy and show status of all pets in each array
